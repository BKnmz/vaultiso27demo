...
def render() -> None:
    ...
    with col_viewer:
        ...
        no_review_html = "<p style='color:var(--ink-3);font-size:12px'>No AI review available. Run the AI Reviewer to see findings.</p>"
        st.markdown(
            ...
            f'{findings_html if findings_html else no_review_html}'
            f'</div>'
            f'</div>',
            unsafe_allow_html=True,
        )
