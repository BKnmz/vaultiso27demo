...
def render() -> None:
    ...
    with col_viewer:
        ...
        findings_fallback = "<p style='color:var(--ink-3);font-size:12px'>No AI review available. Run the AI Reviewer to see findings.</p>"
        st.markdown(
            ...
            f'{findings_html if findings_html else findings_fallback}'
            f'</div>'
            f'</div>',
            unsafe_allow_html=True,
        )
