...
def _tab_model_guide() -> None:
    ...
    for m in MODEL_GUIDE:
        ...
        recommended_badge = "&nbsp;&nbsp;<span style='font-size:10px;background:var(--accent);color:white;border-radius:4px;padding:1px 6px'>recommended</span>"
        cards_html += (
            f'<div class="card" style="padding:0;{border}">'
            f'<div class="card-body">'
            f'<div class="mono" style="font-size:13px;font-weight:500;color:var(--ink)">{m["Model"]}'
            f'{recommended_badge if recommended else ""}'
            f'</div>'
